    ...
    loadConfiguration() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const tokensData = fs_1.default.readFileSync((utils_1.Tools.TOKEN_FILE), 'utf-8');
                ...
                const urlData = fs_1.default.readFileSync(utils_1.Tools.URL_FILE, 'utf-8');
                console.log('Current Configuration:', urlData);
                const urlJson = utils_1.Tools.getConfigAsJson(urlData);
                const { url } = urlJson;
                const canisterIdData = fs_1.default.readFileSync(utils_1.Tools.CANISTER_FILE, 'utf-8');
                console.log('Current Configuration:', canisterIdData);
                const canisterIdJson = utils_1.Tools.getConfigAsJson(canisterIdData);
