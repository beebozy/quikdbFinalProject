...
function deployToLocal(principalId) {
    ...
    shelljs_1.default.exec(`dfx ledger fabricate-cycles --t 1000000 --canister database`, { silent: utils_1.production });
    shelljs_1.default.exec(`dfx ledger fabricate-cycles --t 1000000 --canister test`, { silent: utils_1.production });
