...
init_1.program
    ...
    if (fs.existsSync(utils_1.Tools.CONFIG_FILE)) {
        ...
        ((_b = principal.data) === null || _b === void 0 ? void 0 : _b.seedPhrase) &&
            utils_1.Tools.appendToConfigFile('seedPhrase', (_c = principal.data) === null || _c === void 0 ? void 0 : _c.seedPhrase, 'seedPhrase');
        utils_1.Tools.appendToConfigFile('accessToken', (_e = (_d = auth.data) === null || _d === void 0 ? void 0 : _d.data) === null || _e === void 0 ? void 0 : _e.accessToken, 'accessToken');
        ...
        const projectIdEncryptionResponse = yield (0, http_1.encryptUserData)(projectIdPayload, projectTokenRef);
        ...
        yield (0, http_1.uploadProjectCode)(encryptedProjectId, token, distDir);
        ...
        utils_1.Tools.appendToConfigFile('canisterId', canisterPayload === null || canisterPayload === void 0 ? void 0 : canisterPayload.canisterId, 'canisterId');
        utils_1.Tools.appendToConfigFile('url', canisterPayload === null || canisterPayload === void 0 ? void 0 : canisterPayload.url, 'url');
        const canisterEncryptionResponse = yield (0, http_1.encryptUserData)(JSON.stringify(canisterPayload), projectTokenRef);
        const encryptedCanisterPayload = canisterEncryptionResponse.data.encryptedData;
        console.log({ encryptedCanisterPayload });
        const activateProjectResponse = yield (0, http_1.activateProject)(encryptedProjectId, encryptedCanisterPayload, token);
